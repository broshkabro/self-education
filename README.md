...
- [Git tutorial](https://githowto.com): a guided tour that walks through the fundamentals of Git, inspired by the premise that to know a thing is to do it.
- [Learn Git Branching](https://learngitbranching.js.org/): visual and interactive way to learn Git on the web.
- [Github branches Management](https://github.com/Kunena/Kunena-Forum/wiki/Create-a-new-branch-with-git-and-manage-branches): a short list of useful git commands.
...
- Patterns
  - [JS patterns](https://proglib.io/p/javascript-patterns/)
...
### CSS
  ...
  - Selectors
    - [Pseudo Class Selectors](https://css-tricks.com/pseudo-class-selectors/): a descriptive article about existing pseudo-selectors.
    - [The 30 CSS Selectors You Must Memorize](https://code.tutsplus.com/tutorials/the-30-css-selectors-you-must-memorize--net-16048)
    - [CSS Selector Game](https://flukeout.github.io/)

  - Layout
    - [Floats](https://css-tricks.com/all-about-floats/): an article about floats.
    - [Float labels in inputs](https://css-tricks.com/float-labels-css/)

    - [FlexboxFroggy](http://flexboxfroggy.com/): a game that helps to learn flex-box.
    - [FlexboxDefense](http://www.flexboxdefense.com/): a game that helps to learn flex-box.
    
    - [Everything about Grid](https://gridbyexample.com/): a collection of examples, video and other information that helps to learn CSS Grid Layout.

  - Animation
    - [CSS Animation Libraries](https://css-tricks.com/css-animation-libraries/): a list of libraries that help to animate things.
    - [Cubic-bezier for CSS transitions](http://cubic-bezier.com/#.17,.67,.83,.67): a tool which visualizes the work of Cubic-bezier property.

  - Tools
    - [CSS tools for devs](https://levelup.gitconnected.com/9-useful-css-tools-for-web-developers-4ae3e8747b8a)



### SCSS/SASS

  - [SASS Guid-lines](https://sass-guidelin.es/)
...
- [Coloring SVGs](http://codepen.io/noahblon/post/coloring-svgs-in-css-background-images)
- [SVG icons](https://fvsch.com/code/svg-icons/how-to/#section-styling)
...
- Spec Updates 
  - [JS features 2020](https://medium.com/javascript-in-plain-english/new-javascript-features-in-es2020-c2d76acf9c5a)
...
- JS Console
  - [Mastering JS Console](https://medium.com/javascript-in-plain-english/mastering-js-console-log-like-a-pro-1c634e6393f9)

- Functions
  - [Function secrets](https://medium.com/javascript-in-plain-english/function-in-javascript-has-much-more-secrets-than-you-think-b3bf64055c99)
...
- Objects
  - [Things you should know about objects](https://medium.com/javascript-in-plain-english/six-things-you-should-know-about-objects-in-javascript-ccd11a9e1998)
...
- Spread & Rest
  - [Ways to use spread](https://medium.com/javascript-in-plain-english/8-ways-to-use-spread-operator-in-javascript-b66fcf016efe)

- Promises
  - [Promises in JS](https://medium.com/javascript-scene/master-the-javascript-interview-what-is-a-promise-27fc71e77261)
...
- Tips & Tricks
  - [Guide to Tips & tricks](https://levelup.gitconnected.com/ultimate-guide-to-tips-tricks-and-javascript-features-you-should-know-27e0a4a6ffdf)
  ...
  - [30 Awesome JavaScript Shorthand Techniques That You Should Know](https://javascript.plainenglish.io/30-awesome-javascript-shorthand-techniques-that-are-good-to-know-6590545ced3d)
...
- Routing
  - [React-router Spec](https://reacttraining.com/react-router/web/example/recursive-paths)
...
- Fast refresh
  - [Fast refresh](https://medium.com/javascript-in-plain-english/what-is-react-fast-refresh-f3d1e8401333)

- Components
  - [5 useful React components](https://medium.com/javascript-in-plain-english/here-are-5-useful-react-components-fb3927e7d790)
...
- NgModule
  - [Understanding Angular modules (NgModule)](https://medium.com/@cyrilletuzi/understanding-angular-modules-ngmodule-and-their-scopes-81e4ed6f7407)
...
- Apollo-client
  ...
  - [refetchQueries - Apollo docs](https://www.apollographql.com/docs/react/advanced/caching.html#refetchQueries)
...
- Jest
  ...
  - [Test for object, array, string types](https://github.com/facebook/jest/issues/3457)
  - [Test for array of objects](https://medium.com/@andrei.pfeiffer/jest-matching-objects-in-array-50fe2f4d6b98)
...
- [Multiple html pages using Webpack](https://www.ivarprudnikov.com/static-website-multiple-html-pages-using-webpack-plus-github-example/)


### Tips & Tricks

- [Guide to Non-Rectangular Headers (Part 1)](https://codepen.io/ahmadnassri/post/non-rectangular-headers-part-1)
...
- [Three Line Menu](https://css-tricks.com/three-line-menu-navicon/)
...
- [Analogy Dictionary](https://sidewaysdictionary.com/)
